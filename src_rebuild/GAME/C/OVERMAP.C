...
void DrawTargetBlip(VECTOR *pos,uchar r,uchar g,uchar b,ulong flags)
...
void DrawPlayerDot(VECTOR *pos,short rot,uchar r,uchar g,int b,ulong flags)
...
void WorldToOverheadMapPositions
               (VECTOR *pGlobalPosition,VECTOR *pOverheadMapPosition,int count,char inputRelative,
               int outputRelative)
