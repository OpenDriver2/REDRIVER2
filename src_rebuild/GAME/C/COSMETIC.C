...
{
  LoadfileSeg(CosmeticFiles4[level],&DAT_000f3000,0,0xc30);
  ProcessCosmeticsLump(&DAT_000f3000,0);
  return;
}
...

{
  ...
  iVar4 = 0;
  do {
    externalModelNumber = MissionHeader->residentModels[iVar4];
    if (externalModelNumber == 0xd) {
      externalModelNumber =
           10 - (MissionHeader->residentModels[0] + MissionHeader->residentModels[1] +
                MissionHeader->residentModels[2]);
      if (externalModelNumber < 1) {
        externalModelNumber = 1;
      }
      else {
        if (4 < externalModelNumber) {
    ...
    iVar8 = iVar4 + 1;
    if (externalModelNumber != -1) {
      pCVar3 = car_cosmetics + iVar4;
      puVar2 = (undefined4 *)(lump_ptr + *(int *)(lump_ptr + externalModelNumber * 4));
      puVar1 = puVar2 + 0x38;
      if (((uint)puVar2 & 3) == 0) {
        do {
          uVar5 = puVar2[1];
          uVar6 = puVar2[2];
          uVar7 = puVar2[3];
          *(undefined4 *)&pCVar3->headLight = *puVar2;
          *(undefined4 *)&(pCVar3->headLight).vz = uVar5;
          *(undefined4 *)&pCVar3->frontInd = uVar6;
          *(undefined4 *)&(pCVar3->frontInd).vz = uVar7;
          puVar2 = puVar2 + 4;
      ...
      *(undefined4 *)&(pCVar3->headLight).vz = uVar5;
      *(undefined4 *)&pCVar3->frontInd = uVar6;
      FixCarCos(car_cosmetics + iVar4,externalModelNumber);
    }
    iVar4 = iVar8;
  } while (iVar8 < 5);
  return;
