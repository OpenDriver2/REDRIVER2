...
void RequestSpool(int type,int data,int offset,int loadsize,char *address,undefined1 func)
...
void FoundError(char *name,uchar intr,uchar *result)
...
void ready_cb_textures(uchar intr,uchar *result)
...
void ready_cb_regions(uchar intr,uchar *result)
...
void ready_cb_soundbank(uchar intr,uchar *result)
...
void ready_cb_misc(uchar intr,uchar *result)
