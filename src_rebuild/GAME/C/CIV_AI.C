...
int InitCar(_CAR_DATA *cp,int direction,long (*startPos) [4],uchar control,int model,int palette,
           char *extraData)
...
int GetNextRoadInfo(_CAR_DATA *cp,int randomExit,int *turnAngle,int *startDist,
                   CIV_ROUTE_ENTRY *oldNode)
...
int GetNodePos(DRIVER2_STRAIGHT *straight,DRIVER2_JUNCTION *junction,DRIVER2_CURVE *curve,
              int distAlongPath,_CAR_DATA *cp,int *x,int *z,int laneNo)
...
int CheckChangeLanes(DRIVER2_STRAIGHT *straight,DRIVER2_CURVE *curve,int distAlongSegment,
                    _CAR_DATA *cp,int tryToPark)
...
int CreateCivCarWotDrivesABitThenStops
              (int direction,long (*startPos) [4],long (*stopPos) [4],uchar internalModel,
              int palette)
...
int CreateStationaryCivCar
              (int direction,long orientX,long orientZ,long (*startPos) [4],int externalModel,
              int palette,int controlFlags)
