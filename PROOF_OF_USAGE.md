...
<!-- The example row's hash is the real digest of its own four fields against
     https://github.com/OpenDriver2/REDRIVER2, so it does not match this repository's URL - it is an
...
```bash
printf '%s' "ExampleModel v2:AI Corp:2026-08-12T14:30:00Z:https://github.com/OpenDriver2/REDRIVER2" | shasum -a 256
```

```python
import hashlib
hashlib.sha256("ExampleModel v2:AI Corp:2026-08-12T14:30:00Z:https://github.com/OpenDriver2/REDRIVER2".encode()).hexdigest()
```
